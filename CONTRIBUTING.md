Contributing to Enchant Core
==================================

The Enchant Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Enchant Core project, and is not to be
confused with overall Enchant Network Protocol consensus changes.

Whether a pull request is merged into Enchant Core rests with the project merge
...
Patches that change Enchant consensus rules are considerably more involved than
...
Where a patch set proposes to change the Enchant consensus, it must have been
...
The project leader is the release manager for each Enchant Core release.
