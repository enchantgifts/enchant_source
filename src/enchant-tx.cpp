...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Enchant Core enchant-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  enchant-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded enchant transaction") + "\n" +
                               "  enchant-tx [options] -create [commands]   " + _("Create hex-encoded enchant transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded enchant transaction
