                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(1200, 681), this);

    QString windowTitle = tr("Enchant Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ENCH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and enchant: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Enchant Core"), this);
    aboutAction->setStatusTip(tr("Show information about Enchant Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Enchant"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ENCH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ENCH addresses"));
    ...
    openAction->setStatusTip(tr("Open a enchant: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Enchant Core help message to get a list with possible Enchant command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Enchant Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Enchant network", "", count));
}
...
{
    QString strTitle = tr("Enchant Core"); // default title
