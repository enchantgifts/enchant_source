...
/** Utility functions used by the Enchant Qt UI.
 */
namespace GUIUtil
{
...
// Render ENCH addresses in monospace font
...
// Parse "enchant:" URI into recipient object, return true on successful parsing
