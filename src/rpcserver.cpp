...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Enchant server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Enchant features */
        {"enchant", "masternode", &masternode, true, true, false},
        {"enchant", "listmasternodes", &listmasternodes, true, true, false},
        {"enchant", "getmasternodecount", &getmasternodecount, true, true, false},
        {"enchant", "masternodeconnect", &masternodeconnect, true, true, false},
        {"enchant", "masternodecurrent", &masternodecurrent, true, true, false},
        {"enchant", "masternodedebug", &masternodedebug, true, true, false},
        {"enchant", "startmasternode", &startmasternode, true, true, false},
        {"enchant", "createmasternodekey", &createmasternodekey, true, true, false},
        {"enchant", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"enchant", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"enchant", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"enchant", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"enchant", "getmasternodescores", &getmasternodescores, true, true, false},
        {"enchant", "mnbudget", &mnbudget, true, true, false},
        {"enchant", "preparebudget", &preparebudget, true, true, false},
        {"enchant", "submitbudget", &submitbudget, true, true, false},
        {"enchant", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"enchant", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"enchant", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"enchant", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"enchant", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"enchant", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"enchant", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"enchant", "checkbudgets", &checkbudgets, true, true, false},
        {"enchant", "mnsync", &mnsync, true, true, false},
        {"enchant", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> enchant-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8485/\n";
}
