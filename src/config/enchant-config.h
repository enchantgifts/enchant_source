/* src/config/enchant-config.h.  Generated from enchant-config.h.in by configure.  */
/* src/config/enchant-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ENCH_CONFIG_H

#define ENCH_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.enchant.gift"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Enchant Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Enchant Core 1.1.0"
